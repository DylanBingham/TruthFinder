function createOverallPolarityChart(data, verticalLinePosition) {
    // Configuration
    const container = d3.select("#overall-polarity-chart .chart-svg-container");
    ...
    const filteredData = data.map(d => +d.overall_polarity).filter(d => !isNaN(d));
    ...
    svg.append("text")
        ...
        .style("text-anchor", "middle")
        .text("Distribution of Overall Polarity");
}
